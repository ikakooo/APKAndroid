...
class NewsRecyclerViewAdapter(private val recyclerView: RecyclerView, private val news: MutableList<NewsModel>) :
   ...
   // private var newsRecyclerViewAdapter: NewsRecyclerViewAdapter = this
    ...
    inner class WallPostsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBind() {
            Glide.with(App.instance.getContext()).load(model.cover).into(itemView.newsCoverImageView as ImageView)
